...
# Add a touch sensor
touch = digitalio.DigitalInOut(board.D0)
...
while True:
   ...
   if touch.value == False:
      ...
      position_servo, running_servo, changed_servo = vs_servo.sequence(sequence=servo_sequence_sleep, loop_max=servo_looping)
      ...
      # Make a call to the library and request the desired of our servo motor
      position_servo, running_servo, changed_servo = vs_servo.sequence(sequence=servo_sequence_angry, loop_max=servo_looping)
