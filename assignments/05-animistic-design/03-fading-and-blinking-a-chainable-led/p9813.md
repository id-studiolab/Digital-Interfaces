...
This example used the [Chainable LED](https://id-studiolab.github.io/Connected-Interaction-Kit/components/chainable-led/chainable-led-p9813) of the Connected Interaction Kit, connected to `D13` of the Expander Board.
